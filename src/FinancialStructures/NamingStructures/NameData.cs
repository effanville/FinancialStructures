...
{
    /// <summary>
    /// The broker associated to this fund
    /// </summary>
    ...
    /// Empty constructor.
    /// </summary>
    public NameData() => Sectors = new HashSet<string>();
    ...
    public NameData Copy()
        => new NameData(Company, Name, Currency, Url, Sectors, Notes)
        {
            Ticker = Ticker,
            Exchange = Exchange,
            Isin = Isin,
    ...
    public bool Equals(NameData otherName)
    {
        ...
        bool brokerEqual = Broker?.Equals(otherName.Broker) ?? otherName.Broker == null;
    ...
    public override int GetHashCode()
    {
        ...
        hashCode = 23 * hashCode + Broker?.GetHashCode() ?? 17;
