...
namespace Effanville.FinancialStructures.Persistence.Xml.V1;

[XmlType(TypeName = "SecurityTrade")]
    ...
    IEquatable<XmlTrade>
{
    ...
    public override string ToString()
        => $"{Day.ToIsoString()}-{TradeType}-{Company}-{Name}-{NumberShares}-{UnitPrice}-{TradeCosts}";
}
