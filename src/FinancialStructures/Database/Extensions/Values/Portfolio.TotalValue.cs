...
namespace Effanville.FinancialStructures.Database.Extensions.Values
{
    public static partial class Values
    {
        ...
        /// <param name="identifier">Any name associated with this total, e.g. the Sector name</param>
        /// <returns>The total value held on today.</returns>
        public static decimal TotalValue(this IPortfolio portfolio, Totals account, string identifier = null) 
            => portfolio.TotalValue(account, DateTime.Today, identifier);
        ...
        public static decimal TotalValue(this IPortfolio portfolio, Totals totals, DateTime date, string identifier = null)
        {
