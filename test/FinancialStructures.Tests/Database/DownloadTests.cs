...
namespace Effanville.FinancialStructures.Tests.Database
{
    ...
    public sealed class DownloadTests
    {
        ...
        [TestCase("https://uk.finance.yahoo.com/quote/aht.l", "GBP", 2000,9000)]
        [TestCase("https://uk.finance.yahoo.com/quote/cwr.l", "GBP", 50,1000)]
        [TestCase("https://uk.finance.yahoo.com/quote/drx.L", "GBP", 200,1000)]
        [TestCase("https://uk.finance.yahoo.com/quote/hwdn.L", "GBP", 100,1500)]
        [TestCase("https://uk.finance.yahoo.com/quote/JXN?p=JXN&.tsrc=fin-srch", "GBP", 30,300)]
        [TestCase("https://uk.finance.yahoo.com/quote/hgen.L", "GBP", 10,100)]
        ...
        [TestCase("https://uk.finance.yahoo.com/quote/GRP.L", "GBP", 0.1,10)]
        [TestCase("https://uk.finance.yahoo.com/quote/JXN?p=JXN&.tsrc=fin-srch", "GBP", 10,300)]
        [TestCase("https://uk.finance.yahoo.com/quote/ship.l", "GBP", 1,10)]
