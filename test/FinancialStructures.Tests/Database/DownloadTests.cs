...
namespace Effanville.FinancialStructures.Tests.Database
{
    ...
    public sealed class DownloadTests
    {
        ...
        [TestCase("https://uk.finance.yahoo.com/quote/JXN?p=JXN&.tsrc=fin-srch", "GBP", 0.3,30)]
        ...
        [TestCase("https://uk.finance.yahoo.com/quote/GRP.L", "GBP", 0.001,10)]
        [TestCase("https://uk.finance.yahoo.com/quote/JXN?p=JXN&.tsrc=fin-srch", "GBP", 0.1,30)]
